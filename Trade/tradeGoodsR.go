...
func TradeGoodRData() map[string][]string {
	...
	//fill map
	tgrMap["112"] = []string{"Basic Electronics", "Calculators and Adding Machines", "All", "1d6 x 12", "6000", "In +2, Ht +3, Ri +1", "Ni +2, Lt +1, Po +1", "+0", "-6"}
	tgrMap["113"] = []string{"Basic Electronics", "Video Game Systems", "All", "1d6 x 10", "8000", "In +2, Ht +3, Ri +1", "Ni +2, Lt +1, Po +1", "+0", "-6"}
	tgrMap["114"] = []string{"Basic Electronics", "Multimedia Entertainment Systems", "All", "1d6 x 8", "9000", "In +2, Ht +3, Ri +1", "Ni +2, Lt +1, Po +1", "+0", "-6"}
	tgrMap["115"] = []string{"Basic Electronics", "VR Interaction Systems", "All", "1d6 x 6", "10000", "In +2, Ht +3, Ri +1", "Ni +2, Lt +1, Po +1", "+0", "-6"}
	tgrMap["116"] = []string{"Basic Electronics", "Personal Computers", "All", "1d6 x 10", "10000", "In +2, Ht +3, Ri +1", "Ni +2, Lt +1, Po +1", "+0", "-6"}
	tgrMap["117"] = []string{"Basic Electronics", "Commercial Computers", "All", "1d6 x 7", "11000", "In +2, Ht +3, Ri +1", "Ni +2, Lt +1, Po +1", "+0", "-6"}
	tgrMap["118"] = []string{"Basic Electronics", "Industrial Computers", "All", "1d6 x 5", "12000", "In +2, Ht +3, Ri +1", "Ni +2, Lt +1, Po +1", "+0", "-6"}
	tgrMap["119"] = []string{"Basic Electronics", "Banking Machines", "All", "1d6 x 4", "12000", "In +2, Ht +3, Ri +1", "Ni +2, Lt +1, Po +1", "+0", "-6"}
	tgrMap["1110"] = []string{"Basic Electronics", "Banking Security Systems", "All", "1d6 x 4", "13000", "In +2, Ht +3, Ri +1", "Ni +2, Lt +1, Po +1", "+0", "-6"}
	tgrMap["1111"] = []string{"Basic Electronics", "Banking Computer Systems", "All", "1d6 x 4", "14000", "In +2, Ht +3, Ri +1", "Ni +2, Lt +1, Po +1", "+0", "-6"}
	tgrMap["1112"] = []string{"Basic Electronics", "Microprocessor Assemblies", "All", "1d6 x 2", "14000", "In +2, Ht +3, Ri +1", "Ni +2, Lt +1, Po +1", "+0", "-6"}

	tgrMap["122"] = []string{"Basic Machine Parts", "Stamped Cogs and Sprockets", "All", "1d6 x 12", "8000", "Na +2, In +5", "Ni +3, Ag +2", "+0", "-6"}
	tgrMap["123"] = []string{"Basic Machine Parts", "Piping and Attachment Pieces (low quality)", "All", "1d6 x 10", "8000", "Na +2, In +5", "Ni +3, Ag +2", "+0", "-6"}
	tgrMap["124"] = []string{"Basic Machine Parts", "Piping and Attachment Pieces", "All", "1d6 x 10", "9000", "Na +2, In +5", "Ni +3, Ag +2", "+0", "-6"}
	tgrMap["125"] = []string{"Basic Machine Parts", "Piping and Attachment Pieces (high quality)", "All", "1d6 x 10", "10000", "Na +2, In +5", "Ni +3, Ag +2", "+0", "-6"}
	tgrMap["126"] = []string{"Basic Machine Parts", "Engine Components (low quality)", "All", "1d6 x 10", "9000", "Na +2, In +5", "Ni +3, Ag +2", "+0", "-6"}
	tgrMap["127"] = []string{"Basic Machine Parts", "Engine Components", "All", "1d6 x 10", "10000", "Na +2, In +5", "Ni +3, Ag +2", "+0", "-6"}
	tgrMap["128"] = []string{"Basic Machine Parts", "Engine Components (high quality)", "All", "1d6 x 10", "11000", "Na +2, In +5", "Ni +3, Ag +2", "+0", "-6"}
	tgrMap["129"] = []string{"Basic Machine Parts", "Pneumatics and Hydraulics (low quality)", "All", "1d6 x 6", "9500", "Na +2, In +5", "Ni +3, Ag +2", "+0", "-6"}
	tgrMap["1210"] = []string{"Basic Machine Parts", "Pneumatics and Hydraulics", "All", "1d6 x 6", "11000", "Na +2, In +5", "Ni +3, Ag +2", "+0", "-6"}
	tgrMap["1211"] = []string{"Basic Machine Parts", "Pneumatics and Hydraulics (high quality)", "All", "1d6 x 6", "12500", "Na +2, In +5", "Ni +3, Ag +2", "+0", "-6"}
	...
	tgrMap["133"] = []string{"Basic Manufactured Goods", "Uniforms/Clothing Products (high quality)", "All", "1d6 x 10", "11000", "Na +2, In +5", "Ni +3, Hi +2", "+0", "-6"}
	tgrMap["134"] = []string{"Basic Manufactured Goods", "Uniforms/Clothing Products", "All", "1d6 x 10", "9000", "Na +2, In +5", "Ni +3, Hi +2", "+0", "-6"}
	tgrMap["135"] = []string{"Basic Manufactured Goods", "Uniforms/Clothing Products (low quality)", "All", "1d6 x 10", "7000", "Na +2, In +5", "Ni +3, Hi +2", "+0", "-6"}
	tgrMap["136"] = []string{"Basic Manufactured Goods", "Residential Appliances (low quality)", "All", "1d6 x 10", "9000", "Na +2, In +5", "Ni +3, Hi +2", "+0", "-6"}
	tgrMap["137"] = []string{"Basic Manufactured Goods", "Residential Appliances", "All", "1d6 x 10", "10000", "Na +2, In +5", "Ni +3, Hi +2", "+0", "-6"}
	tgrMap["138"] = []string{"Basic Manufactured Goods", "Residential Appliances (high quality)", "All", "1d6 x 10", "11000", "Na +2, In +5", "Ni +3, Hi +2", "+0", "-6"}
	tgrMap["139"] = []string{"Basic Manufactured Goods", "Furniture/Storage Systems/Tools (low quality)", "All", "1d6 x 5", "9500", "Na +2, In +5", "Ni +3, Hi +2", "+0", "-6"}
	tgrMap["1310"] = []string{"Basic Manufactured Goods", "Furniture/Storage Systems/Tools", "All", "1d6 x 5", "11000", "Na +2, In +5", "Ni +3, Hi +2", "+0", "-6"}
	tgrMap["1311"] = []string{"Basic Manufactured Goods", "Furniture/Storage Systems/Tools (high quality)", "All", "1d6 x 5", "13000", "Na +2, In +5", "Ni +3, Hi +2", "+0", "-6"}
	...
	tgrMap["143"] = []string{"Basic Raw Materials", "Workable Metals (high quality)", "All", "1d6 x 12", "3500", "Ag +3, Ga +2", "In +2, Po +2", "+0", "-6"}
	tgrMap["144"] = []string{"Basic Raw Materials", "Workable Metals", "All", "1d6 x 12", "3000", "Ag +3, Ga +2", "In +2, Po +2", "+0", "-6"}
	tgrMap["145"] = []string{"Basic Raw Materials", "Workable Metals (low quality)", "All", "1d6 x 12", "2500", "Ag +3, Ga +2", "In +2, Po +2", "+0", "-6"}
	tgrMap["146"] = []string{"Basic Raw Materials", "Workable Alloys (low quality)", "All", "1d6 x 10", "4500", "Ag +3, Ga +2", "In +2, Po +2", "+0", "-6"}
	tgrMap["147"] = []string{"Basic Raw Materials", "Workable Alloys", "All", "1d6 x 10", "5000", "Ag +3, Ga +2", "In +2, Po +2", "+0", "-6"}
	tgrMap["148"] = []string{"Basic Raw Materials", "Workable Alloys (high quality)", "All", "1d6 x 10", "5500", "Ag +3, Ga +2", "In +2, Po +2", "+0", "-6"}
	tgrMap["149"] = []string{"Basic Raw Materials", "Fabricated Plastics (low quality)", "All", "1d6 x 5", "6000", "Ag +3, Ga +2", "In +2, Po +2", "+0", "-6"}
	tgrMap["1410"] = []string{"Basic Raw Materials", "Fabricated Plastics", "All", "1d6 x 5", "7000", "Ag +3, Ga +2", "In +2, Po +2", "+0", "-6"}
	tgrMap["1411"] = []string{"Basic Raw Materials", "Fabricated Plastics (high quality)", "All", "1d6 x 5", "8000", "Ag +3, Ga +2", "In +2, Po +2", "+0", "-6"}
	...
	tgrMap["153"] = []string{"Basic Consumables", "Food-grade Vegetation (high quality)", "All", "1d6 x 10", "1100", "Ag +3, Wa +2, Ga +1, As -4", "As +1, Fl +1, Ic +1, Hi +1", "+0", "-6"}
	tgrMap["154"] = []string{"Basic Consumables", "Food-grade Vegetation", "All", "1d6 x 10", "1000", "Ag +3, Wa +2, Ga +1, As -4", "As +1, Fl +1, Ic +1, Hi +1", "+0", "-6"}
	tgrMap["155"] = []string{"Basic Consumables", "Food-grade Vegetation (low quality)", "All", "1d6 x 10", "900", "Ag +3, Wa +2, Ga +1, As -4", "As +1, Fl +1, Ic +1, Hi +1", "+0", "-6"}
	tgrMap["156"] = []string{"Basic Consumables", "Pre-packaged Food and Drink (low quality)", "All", "1d6 x 10", "1500", "Ag +3, Wa +2, Ga +1, As -4", "As +1, Fl +1, Ic +1, Hi +1", "+0", "-6"}
	...
	tgrMap["158"] = []string{"Basic Consumables", "Pre-packaged Food and Drink (high quality)", "All", "1d6 x 10", "2500", "Ag +3, Wa +2, Ga +1, As -4", "As +1, Fl +1, Ic +1, Hi +1", "+0", "-6"}
	tgrMap["159"] = []string{"Basic Consumables", "Survival Rations and Storage-packed Liquids (low quality)", "All", "1d6 x 8", "2500", "Ag +3, Wa +2, Ga +1, As -4", "As +1, Fl +1, Ic +1, Hi +1", "+0", "-6"}
	...
	tgrMap["1511"] = []string{"Basic Consumables", "Survival Rations and Storage-packed Liquids (high quality)", "All", "1d6 x 8", "3500", "Ag +3, Wa +2, Ga +1, As -4", "As +1, Fl +1, Ic +1, Hi +1", "+0", "-6"}
	tgrMap["1512"] = []string{"Basic Consumables", "Junk Food/Soda/Beer", "All", "1d6 x 4", "5000", "Ag +3, Wa +2, Ga +1, As -4", "As +1, Fl +1, Ic +1, Hi +1", "+0", "-6"}

	tgrMap["162"] = []string{"Basic Ore", "Bornite/Galena/Sedimentary Stone", "All", "1d6 x 14", "250", "As +4, Ic +0", "In +3, Ni +1", "+0", "-6"}
	tgrMap["163"] = []string{"Basic Ore", "Chalcocite/Talc (high quality)", "All", "1d6 x 12", "600", "As +4, Ic +0", "In +3, Ni +1", "+0", "-6"}
	tgrMap["164"] = []string{"Basic Ore", "Chalcocite/Talc", "All", "1d6 x 12", "500", "As +4, Ic +0", "In +3, Ni +1", "+0", "-6"}
	tgrMap["165"] = []string{"Basic Ore", "Chalcocite/Talc (low quality)", "All", "1d6 x 12", "400", "As +4, Ic +0", "In +3, Ni +1", "+0", "-6"}
	tgrMap["166"] = []string{"Basic Ore", "Bauxite, Coltan and Wolframite (low quality)", "All", "1d6 x 10", "900", "As +4, Ic +0", "In +3, Ni +1", "+0", "-6"}
	tgrMap["167"] = []string{"Basic Ore", "Bauxite, Coltan and Wolframite", "All", "1d6 x 10", "1000", "As +4, Ic +0", "In +3, Ni +1", "+0", "-6"}
	tgrMap["168"] = []string{"Basic Ore", "Bauxite, Coltan and Wolframite (high quality)", "All", "1d6 x 10", "1100", "As +4, Ic +0", "In +3, Ni +1", "+0", "-6"}
	tgrMap["169"] = []string{"Basic Ore", "Acanthite, Cobaltite or Magnetite (low quality)", "All", "1d6 x 8", "1300", "As +4, Ic +0", "In +3, Ni +1", "+0", "-6"}
	tgrMap["1610"] = []string{"Basic Ore", "Acanthite, Cobaltite or Magnetite", "All", "1d6 x 8", "1500", "As +4, Ic +0", "In +3, Ni +1", "+0", "-6"}
	tgrMap["1611"] = []string{"Basic Ore", "Acanthite, Cobaltite or Magnetite (high quality)", "All", "1d6 x 8", "1700", "As +4, Ic +0", "In +3, Ni +1", "+0", "-6"}
	...
	tgrMap["633"] = []string{"Drugs, Illegal", "Chemical Depressants/Natural Narcotics (high quality)", "As, De, Hi, Wa", "1d6 x 1 + 1", "60000", "As +0, De +0, Ga +0, Wa +0", "Ri +6, Hi +6", "+4", "+6"}
	...
	tgrMap["635"] = []string{"Drugs, Illegal", "Chemical Depressants/Natural Narcotics (low quality)", "As, De, Hi, Wa", "1d6 x 1 + 1", "40000", "As +0, De +0, Ga +0, Wa +0", "Ri +6, Hi +6", "+4", "+6"}
	tgrMap["636"] = []string{"Drugs, Illegal", "Chemical Stimulants and Hallucinogens (low quality)", "As, De, Hi, Wa", "1d6 x 1", "75000", "As +0, De +0, Ga +0, Wa +0", "Ri +6, Hi +6", "+4", "+6"}
	...
	tgrMap["638"] = []string{"Drugs, Illegal", "Chemical Stimulants and Hallucinogens (high quality)", "As, De, Hi, Wa", "1d6 x 1", "125000", "As +0, De +0, Ga +0, Wa +0", "Ri +6, Hi +6", "+4", "+6"}
	tgrMap["639"] = []string{"Drugs, Illegal", "Designer Narcotics (low quality)", "As, De, Hi, Wa", "1d6 x 0 + 2", "150000", "As +0, De +0, Ga +0, Wa +0", "Ri +6, Hi +6", "+4", "+6"}
	tgrMap["6310"] = []string{"Drugs, Illegal", "Designer Narcotics", "As, De, Hi, Wa", "1d6 x 0 + 2", "200000", "As +0, De +0, Ga +0, Wa +0", "Ri +6, Hi +6", "+4", "+6"}
	tgrMap["6311"] = []string{"Drugs, Illegal", "Designer Narcotics (high quality)", "As, De, Hi, Wa", "1d6 x 0 + 2", "250000", "As +0, De +0, Ga +0, Wa +0", "Ri +6, Hi +6", "+4", "+6"}
	...
	tgrMap["643"] = []string{"Luxuries, Illegal", "Black-data Recordings", "Ag, Ga, Wa", "1d6 x 1", "25000", "Ag +2, Ga +0, Wa +1", "Ri +6, Hi +4", "+4", "+4"}
	tgrMap["644"] = []string{"Luxuries, Illegal", "Slaving Gear", "Ag, Ga, Wa", "1d6 x 1", "25000", "Ag +2, Ga +0, Wa +1", "Ri +6, Hi +4", "+4", "+4"}
	tgrMap["645"] = []string{"Luxuries, Illegal", "Living Slaves", "Ag, Ga, Wa", "1d6 x 1", "25000", "Ag +2, Ga +0, Wa +1", "Ri +6, Hi +4", "+4", "+4"}
	tgrMap["646"] = []string{"Luxuries, Illegal", "Extinct Animal Products (Body Parts)", "Ag, Ga, Wa", "1d6 x 1", "50000", "Ag +2, Ga +0, Wa +1", "Ri +6, Hi +4", "+4", "+4"}
	tgrMap["647"] = []string{"Luxuries, Illegal", "Extinct Animal Products (Chemicals)", "Ag, Ga, Wa", "1d6 x 1", "50000", "Ag +2, Ga +0, Wa +1", "Ri +6, Hi +4", "+4", "+4"}
	tgrMap["648"] = []string{"Luxuries, Illegal", "Extinct Animal Bio-Products", "Ag, Ga, Wa", "1d6 x 1", "50000", "Ag +2, Ga +0, Wa +1", "Ri +6, Hi +4", "+4", "+4"}
	tgrMap["649"] = []string{"Luxuries, Illegal", "BTL Devices", "Ag, Ga, Wa", "1d6 x 0 + 2", "100000", "Ag +2, Ga +0, Wa +1", "Ri +6, Hi +4", "+4", "+4"}
	tgrMap["6410"] = []string{"Luxuries, Illegal", "Cloning Equipment", "Ag, Ga, Wa", "1d6 x 0 + 2", "100000", "Ag +2, Ga +0, Wa +1", "Ri +6, Hi +4", "+4", "+4"}
	tgrMap["6411"] = []string{"Luxuries, Illegal", "Cloning Material", "Ag, Ga, Wa", "1d6 x 0 + 2", "100000", "Ag +2, Ga +0, Wa +1", "Ri +6, Hi +4", "+4", "+4"}
	...
	tgrMap["653"] = []string{"Weapons, Illegal", "Protected Technologies", "In, Ht", "1d6 x 5", "100000", "In +0, Ht +2", "Po +6, AZ +8, RZ +10", "+5", "+6"}
	tgrMap["654"] = []string{"Weapons, Illegal", "Explosive", "In, Ht", "1d6 x 5", "100000", "In +0, Ht +2", "Po +6, AZ +8, RZ +10", "+5", "+6"}
	tgrMap["655"] = []string{"Weapons, Illegal", "Incendiary Ammunition", "In, Ht", "1d6 x 5", "100000", "In +0, Ht +2", "Po +6, AZ +8, RZ +10", "+5", "+6"}
	tgrMap["656"] = []string{"Weapons, Illegal", "Synthetic Poisons", "In, Ht", "1d6 x 5", "150000", "In +0, Ht +2", "Po +6, AZ +8, RZ +10", "+5", "+6"}
	tgrMap["657"] = []string{"Weapons, Illegal", "Personal-scale Mass Trauma Explosives", "In, Ht", "1d6 x 5", "150000", "In +0, Ht +2", "Po +6, AZ +8, RZ +10", "+5", "+6"}
	tgrMap["658"] = []string{"Weapons, Illegal", "Synthetic Poisons and Personal-scale Mass Trauma Explosives", "In, Ht", "1d6 x 5", "150000", "In +0, Ht +2", "Po +6, AZ +8, RZ +10", "+5", "+6"}
	tgrMap["659"] = []string{"Weapons, Illegal", "Arclight Weaponry", "In, Ht", "1d6 x 2", "300000", "In +0, Ht +2", "Po +6, AZ +8, RZ +10", "+5", "+6"}
	tgrMap["6510"] = []string{"Weapons, Illegal", "Biological or Chemical Weaponry", "In, Ht", "1d6 x 2", "300000", "In +0, Ht +2", "Po +6, AZ +8, RZ +10", "+5", "+6"}
	tgrMap["6511"] = []string{"Weapons, Illegal", "Naval Starship Weaponry", "In, Ht", "1d6 x 2", "300000", "In +0, Ht +2", "Po +6, AZ +8, RZ +10", "+5", "+6"}
	...
	//return 6ata
	tgrMap["662"] = []string{"Exotic, Illegal", "*UNDEFINED*", "In", "1d6 x 1", "1000", "In +0", "Po +6, AZ +8, RZ +10", "+5", "+6"}
	tgrMap["663"] = []string{"Exotic, Illegal", "*UNDEFINED*", "In", "1d6 x 1", "1000", "In +0", "Po +6, AZ +8, RZ +10", "+5", "+6"}
	tgrMap["664"] = []string{"Exotic, Illegal", "*UNDEFINED*", "In", "1d6 x 1", "1000", "In +0", "Po +6, AZ +8, RZ +10", "+5", "+6"}
	tgrMap["665"] = []string{"Exotic, Illegal", "*UNDEFINED*", "In", "1d6 x 1", "1000", "In +0", "Po +6, AZ +8, RZ +10", "+5", "+6"}
	tgrMap["666"] = []string{"Exotic, Illegal", "*UNDEFINED*", "In", "1d6 x 1", "1000", "In +0", "Po +6, AZ +8, RZ +10", "+5", "+6"}
	tgrMap["667"] = []string{"Exotic, Illegal", "*UNDEFINED*", "In", "1d6 x 1", "1000", "In +0", "Po +6, AZ +8, RZ +10", "+5", "+6"}
	tgrMap["668"] = []string{"Exotic, Illegal", "*UNDEFINED*", "In", "1d6 x 1", "1000", "In +0", "Po +6, AZ +8, RZ +10", "+5", "+6"}
	tgrMap["669"] = []string{"Exotic, Illegal", "*UNDEFINED*", "In", "1d6 x 1", "1000", "In +0", "Po +6, AZ +8, RZ +10", "+5", "+6"}
	tgrMap["6610"] = []string{"Exotic, Illegal", "*UNDEFINED*", "In", "1d6 x 1", "1000", "In +0", "Po +6, AZ +8, RZ +10", "+5", "+6"}
	tgrMap["6611"] = []string{"Exotic, Illegal", "*UNDEFINED*", "In", "1d6 x 1", "1000", "In +0", "Po +6, AZ +8, RZ +10", "+5", "+6"}
	tgrMap["6612"] = []string{"Exotic, Illegal", "*UNDEFINED*", "In", "1d6 x 1", "1000", "In +0", "Po +6, AZ +8, RZ +10", "+5", "+6"}
	return tgrMap
}
