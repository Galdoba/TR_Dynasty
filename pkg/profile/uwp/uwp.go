...
/*
///Spaceport
A, Космопорт класса А (Отличный):.Верфи (любые); Ремонт любой сложности; Очищенное топливо,
B, Космопорт класса B (Хороший):.Верфи (до 5000t); Ремонт любой сложности; Очищенное топливо,
C, Космопорт класса C (Обычный):.Верфи (до 100t); Ремонт любой сложности; Неочищенное топливо,
D, Космопорт класса D (Плохой):.Ограниченный ремонт; Неочищенное топливо,
E, Космопорт класса E (Условный):.Гарантированные услуги отсуствуют,
X, Космопорт отсуствует,
///Size
0, Размер 0:.Диаметр: менее 1000 км; Гравитация: незначительная,
1, Размер 1:.Диаметр: 1600 км; Гравитация: 0.12,
2, Размер 2:.Диаметр: 3200 км; Гравитация: 0.25,
3, Размер 3:.Диаметр: 4800 км; Гравитация: 0.38,
4, Размер 4:.Диаметр: 6400 км; Гравитация: 0.50,
5, Размер 5:.Диаметр: 8000 км; Гравитация: 0.63,
6, Размер 6:.Диаметр: 9600 км; Гравитация: 0.75,
7, Размер 7:.Диаметр: 11200 км; Гравитация: 0.88,
8, Размер 8:.Диаметр: 12800 км; Гравитация: 1.00,
9, Размер 9:.Диаметр: 14400 км; Гравитация: 1.12,
A, Размер 10:.Диаметр: 16000 км; Гравитация: 1.25,
B, Размер 11:.Диаметр: 17600 км; Гравитация: 1.38,
C, Размер 12:.Диаметр: 19200 км; Гравитация: 1.50,
D, Размер 13:.Диаметр: 20800 км; Гравитация: 1.63,
E, Размер 14:.Диаметр: 22400 км; Гравитация: 1.75,
F, Размер 15:.Диаметр: 24000 км; Гравитация: 2.00,
///Atmo
0, Атмосфера 0:.Отсуствует; Требуется скафандр (Давление: Отсуствует),
1, Атмосфера 1:.Незначительная.Требуется скафандр (Давление: 0.001-0.09 Бар),
2, Атмосфера 2:.Очень разреженная; Заражена.Требуется респиратор и фильтр (Давление: 0.1-0.42 Бар),
3, Атмосфера 3:.Очень разреженная.Требуется респиратор (Давление: 0.1-0.42 Бар),
4, Атмосфера 4:.Разреженная; Заражена.Требуется фильтр (Давление: 0.43-0.7 Бар),
5, Атмосфера 5:.Разреженная.Пригодна для дыхания (Давление: 0.43-0.7 Бар),
6, Атмосфера 6:.Стандартная.Пригодна для дыхания (Давление: 0.7-1.49 Бар),
7, Атмосфера 7:.Стандартная; Заражена.Требуется фильтр (Давление: 0.7-1.49 Бар),
8, Атмосфера 8:.Плотная.Пригодна для дыхания (Давление: 1.5-2.49 Бар),
9, Атмосфера 9:.Плотная; Заражена.Требуется фильтр (Давление: 1.5-2.49 Бар),
A, Атмосфера 10:.Экзотическая.Требуется дыхательная смесь (Давление: варьируется),
B, Атмосфера 11:.Карозийная.Требуется скафандр (Давление: варьируется),
C, Атмосфера 12:.Крайне карозийная.Требуется скафандр (Давление: варьируется),
D, Атмосфера 13:.Очень плотная.Пригодна для дыхания выше определенной высоты (Давление: 2.5 Бар и более),
E, Атмосфера 14:.Крайне разряжена.Пригодна для дыхания ниже определенной высоты (Давление: 0.5 Бар и менее),
F, Атмосфера 15:.Необычная.Непригодня для дыхания (Давление: варьируется),
///hydro
0, Гидросфера 0:.Покрыто водой от 0% до 5% (мир-пустыня),
1, Гидросфера 1:.Покрыто водой от 6% до 15% (сухой мир),
2, Гидросфера 2:.Покрыто водой от 16% до 25% (несколько малых море),
3, Гидросфера 3:.Покрыто водой от 26% до 35% (малые моря и океаны),
4, Гидросфера 4:.Покрыто водой от 36% до 45% (влажный мир),
5, Гидросфера 5:.Покрыто водой от 46% до 55% (большой океан),
6, Гидросфера 6:.Покрыто водой от 56% до 65% (большие океаны),
7, Гидросфера 7:.Покрыто водой от 66% до 75% (несколько материков),
8, Гидросфера 8:.Покрыто водой от 76% до 85% (несколько больших островов и архепелагов),
9, Гидросфера 9:.Покрыто водой от 86% до 95% (почти полностью покрыт водой),
A, Гидросфера 10:.Покрыто водой от 96% до 100% (водный мир),
///Pops
0, Население: 0 (Отсуствует),
1, Население: 1 (Десятки),
2, Население: 2 (Сотни),
3, Население: 3 (Тысячи),
4, Население: 4 (Десятки тысяч),
5, Население: 5 (Сотни тысяч),
6, Население: 6 (Миллионы),
7, Население: 7 (Десятки миллионов),
8, Население: 8 (Сотни миллионов),
9, Население: 9 (Миллиарды),
A, Население: 10 (Десятки миллиардов),
B, Население: 11 (Сотни миллиардов),
C, Население: 12 (Триллионы),
D, Население: 13 (Десятки триллионов),
E, Население: 14 (Сотни триллионов),
F, Население: 15 (Квадриллионы),
///Govr
0, Тип правительства: Отсуствует.Превалируют личные и семейные связи,
1, Тип правительства: Корпоративный контроль.Функции правления отданы компании а большинство граждан являются её сотрудниками,
2, Тип правительства: Прямая демократия.Правление осуществляется с помощью прямого участия граждан,
3, Тип правительства: Самовоспроизводящаяся олигархия.Правлением занимается закрытое меньшенство когда как большинство не участвует в процессе,
4, Тип правительства: Представительная демократия.Функции правительства выполняют избранные представители общества,
5, Тип правительства: Феодальная технократия.Правительство формируется из индивидов имеющих больший доступ к технологиям чем у масс и основывается на принципах взаимовыгоды и эффективности,
6, Тип правительства: Марионеточное правительство.Правительство формируется и контролируется внешними силами,
7, Тип правительства: Национальные государства. Централизованное планетарное правительство отсуствует; Мир поделен на ряд регионов или группировок каждая из которых формирует свой строй и стремится к доминированию над планетой,
8, Тип правительства: Бюрократия государственной службы. Управление миром выполняется государственными институтами нанимающих индивидов соответствующих уровню требуемой экспертизы,
9, Тип правительства: Безличная бюрократия. Правящие институты отделены от управляемого населения,
A, Тип правительства: Харизматический диктатор. Правительство возглавляется одним лидером пользующегося поддержкой большинства населения,
B, Тип правительства: Нехаризматический диктатор. Правительство возглавляется одним лидером пришедшим к власти легтимным способом.,
C, Тип правительства: Харизматическая олигархия. Правительство возглавляется группой лиц пользующихся поддержкой большинства населения,
D, Тип правительства: Религиозная диктатура. Правительство формируется религиозной организации не принимающей во внимания конкретные нужды граждан,
E, Тип правительства: Религиозная автократия. Правительство подчиняется одному религиозному лидеру имеющим абсолютную власть над гражданами,
F, Тип правительства: Тоталитарная олигархия. Правительство контролируется меньшенством обладающим абсолютной властью и поддерживающим контроль с помощью запугивания населения,
///Laws
0, Строгость законов: 0.Ограничения отсуствуют.Тяжелая броня и вооружения могут быть необходимы,
1, Строгость законов: 1.Общество поддерживает запреты только на самые экстремальные поступки или вооружение.Запрещено: химическое биологическое и оружие массового поражения; тяжелые боевые экзоскелеты,
2, Строгость законов: 2.Общество контролирует и следит за общей безопасностью.Запрещено: портативное лазерное и энергетическое оружие; боевую броню армейского уровня,
3, Строгость законов: 3.Власти стараются защитить население. Запрещено: военное оружие (пулеметы, штурмое автоматическое оружие); композитную броню,
4, Строгость законов: 4.Законы стремятся запретить все что может причинить непопровимый урон обществу. Запрещено: легкое штурмовое и автоматическое оружие; балестическую и кувларовую одежду,
5, Строгость законов: 5.Законы могут использоваться для ограничений того что может повредить власти. Запрещено: скрытое оружие; бронежилеты,
6, Строгость законов: 6.Законы запрещают конкретные инструменты и деятельность по обеспечению безопасности вынуждая людей искать защиты у правительства.Запрещено: любое стрелковое оружие кроме охотничьего; бронежилеты,
7, Строгость законов: 7.Shotguns prohibited. Большая часть оружия и средств защиты контролируется правительством. Запрещено: охотничье и помповое оружие; бронежилеты,
8, Строгость законов: 8.Правительство ограничивает часть свобод граждан. Запрещено: открытое ношение оружия; холодное и травмотическое оружие; любая очевидная броня,
9, Строгость законов: 9.Ничего что не лицензируется правительством не может быть доступно людям.Запрещено: любые изделия сходные с оружием; любая броня,
A, Строгость законов: 10.Запрещено все что может использоваться как оружие.,
B, Строгость законов: 11.Правительство плотно контролирует любые гражданские инициативы.Запрещено: любые изделия сходные с оружием; любая броня,
C, Строгость законов: 12.Правительство не ограничено в возможности вмешиваться в частную жизнь граждан.Запрещено: любые изделия сходные с оружием; любая броня,
D, Строгость законов: 13.Порядок обеспечивается силами военизированных структур..Запрещено: любые изделия сходные с оружием; любая броня,
E, Строгость законов: 14.Полномасштабное полицейское государство..Запрещено: любые изделия сходные с оружием; любая броня,
F, Строгость законов: 15.Все аспекты повседневности регламентированы и контролируются правительством..Запрещено: любые изделия сходные с оружием; любая броня,
G, Строгость законов: 16.Правительство сурово карает даже за малозначительные проступки..Запрещено: любые изделия сходные с оружием; любая броня,
H, Строгость законов: 17.Легализованые практики угнетения, геноцида и преследований..Запрещено: любые изделия сходные с оружием; любая броня,
J, Строгость законов: 18.Практики угнетения, геноцида и преследований являются рутиной..Запрещено: любые изделия сходные с оружием; любая броня,
K, Строгость законов: 19.Черезвычайно угнетающие порядки во всех сферах жизни..Запрещено: любые изделия сходные с оружием; любая броня,
L, Строгость законов: 20.Полный контроль правительства над обществом лишает индивида всех прав..Запрещено: любые изделия сходные с оружием; любая броня,
///TL
0, Технологический уровень 0.Технологии уровня каменного века,
1, Технологический уровень 1.Технологии уровня бронзового или железгого веков,
2, Технологический уровень 2.Появление печатного станка; эквивалент технологий 15-18 веков,
3, Технологический уровень 3.Сформирован научный подход; эквивалент технологий 19 века,
4, Технологический уровень 4.Появления двигателя внутреннего сгорания; эквивалент первой трети 20 века,
5, Технологический уровень 5.Внедрение массового производства; эквивалент середины 20 века,
6, Технологический уровень 6.Ядерная энергетика; эквивалент последней трети 20 века,
7, Технологический уровень 7.Миниатюризация электроники; эквивалент современного мира,
8, Технологический уровень 8.Массовая цифровизация; эквивалент ближайшего будущего,
9, Технологический уровень 9.Развитие анти-гравитационных технологий и холодного синтеза; эквивалент того как мы представляем себе конец 21 века,
A, Технологический уровень 10.Освоение технологии гипер прыжка,
B, Технологический уровень 11.Появление первых ИИ; развите интерфейса человек-машина,
C, Технологический уровень 12.Контроль над погодой; портативное плазменное вооружение,
D, Технологический уровень 13.Развитие боевых экзоскелетов; оттачивание технологий клонирования,
E, Технологический уровень 14.Строительство мега структур и летающих городов,
F, Технологический уровень 15.Создание синтетических агатиков и черной сферы,
G, Технологический уровень 16.Возникновение самовоспроизводящихся ИИ,
H, Технологический уровень 17.Развиваются технологии перманентных манипуляций с гравитацией и трансплантации сознания,
